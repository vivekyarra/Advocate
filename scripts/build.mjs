...
const required = ['index.html', 'favicon.svg', 'LICENSE', 'README.md', 'src/main.js', 'src/webmcp.js', 'src/domain.js', 'src/repository.js', 'src/ui.js', 'src/styles.css'];

for (const file of required) await access(path.join(root, file), constants.R_OK);

const filesToScan = ['index.html', 'README.md', 'src/main.js', 'src/webmcp.js', 'src/domain.js', 'src/ui.js', 'src/styles.css'];
